...
func TestSemanticMediaFieldsOverrideTechnicalFallback(t *testing.T) {
	...
	item := resolveMedia("file", "Interstellar.mkv", map[string]MediaCandidate{
		"embedded": {Kind: "video", Title: "Interstellar", Line1: "1920 × 1080", Line2: "H264 · AAC", Line3: "2:49:00 · MKV"},
		"filename": {Kind: "movie", Title: "Interstellar", Year: &year, Line1: "2014"},
		"tmdb":     {Kind: "movie", Title: "星际穿越", Year: &year, Line1: "2014", Line2: "Interstellar"},
	})
	if item.Kind != "movie" || item.Title != "星际穿越" || item.Line1 != "2014" || item.Line2 != "Interstellar" || item.Line3 != "2:49:00 · MKV" {
