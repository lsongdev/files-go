...
func Video(catalog *catalog.Catalog, storages *storage.Registry, thumbnail *processor.Thumbnail, ffprobe, ffmpeg string) Plugin {
	return NewPlugin("video", func(entry model.Entry) bool {
