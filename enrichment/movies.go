...
func Movies(video *mediaengine.VideoEnricher, directory *mediaengine.DirectoryEnricher, artwork *mediaengine.Artwork) processor.Plugin {
	return processor.NewPlugin("movies", func(entry model.Entry) bool {
